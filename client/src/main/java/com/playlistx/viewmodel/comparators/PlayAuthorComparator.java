 ...
 * <br> Sorts playlists by their author.
 *
 ...
 * @since 0.5
 */
public class PlayAuthorComparator implements Comparator<Playlist> {
    /**
    ...
    public int compare(@NotNull Playlist firstPlay, @NotNull Playlist secondPlay) {
        String[] comparator = {firstPlay.getOwner(), secondPlay.getOwner()};
        Arrays.sort(comparator);
        if (comparator[0].equalsIgnoreCase(firstPlay.getOwner())) return -1;
        else return 1;
    }
