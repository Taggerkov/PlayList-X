 ...
 * <br> Sorts playlists by their song count.
 *
 ...
 * @since 0.5
 */
public class PlaySongCountComparator implements Comparator<Playlist> {
    /**
    ...
    public int compare(@NotNull Playlist firstPlay, @NotNull Playlist secondPlay) {
        return firstPlay.getSongsCount() - secondPlay.getSongsCount();
    }
